        ...
        <>
            <Container id="footer" className="mb-4">
                <Row className="mb-3">
                    ...
                    <div className="col-12 col-sm  text-center text-sm mt-sm mt-3">
                        <a href="mailto:afigueredo2000@gmail.com" id="mail">afigueredo2000@gmail.com</a>
                    </div>
                </Row>
                <Row>
                    <a href="https://api.whatsapp.com/send?phone=+34611676101&text=%C2%A1Hola!%20Gracias%20por%20contactar%20conmigo.%20Deja%20tu%20mensaje,%20te%20respondere%20en%20breve." target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faWhatsapp} className="fa-whatsapp"/></a>
                </Row>
            </Container>
        </>
    )
